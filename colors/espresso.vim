" Vim color file
" Converted from Textmate theme Espresso using Coloration v0.2.5 (http://github.com/sickill/coloration)
...
hi LineNr  guifg=#dddddd guibg=#ffffff gui=NONE
...
hi NonText  guifg=#ffffff guibg=#ffffff gui=NONE
